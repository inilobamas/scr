...
def buildTestSet(query):
    try:
        tweets_fetched = twitter_api.GetSearch(query, count=100)
...
# search_term = input("politics")
print("FINISH DATA SETUP")
testDataSet = buildTestSet("twitter") # search_term
...
corpusFile = "/Users/bamasangkasa/PycharmProjects/Kampus/Paido/corpus.csv"
tweetDataFile = "/Users/bamasangkasa/PycharmProjects/Kampus/Paido/tweetDataFile.csv"
