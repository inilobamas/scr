...
# 	# Get Tweet 3 Months Ago
# 	tweetCriteria = got.manager.TweetCriteria().setQuerySearch('#ibukotabaru').setSince("2018-08-26").setUntil("2019-08-27")
# 	tweet = got.manager.TweetManager.getTweets(tweetCriteria)
# 	# print(tweet)
# 	printTweet("### GET IBUKOTABARU", tweet)
